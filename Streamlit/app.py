...
if selected_tab == "Try":
    try:
        ...
        if extraction_method == "PyPDF":
            response = requests.get(f"https://pdf-qna-fastapi-e398b25aae73.herokuapp.com/dextract_text/?selected_tab=Try&user_url_input={user_url_input}&&extraction_method={extraction_method}")
