...
metadata_fields_ls = json.dumps([{"link": "https://www.sec.gov/files/form1.pdf", "Processing_method": "PyPDF"}, {"link": "https://www.sec.gov/files/form1-a.pdf", "Processing_method": "PyPDF"}, {"link": "https://www.sec.gov/files/form1-e.pdf", "Processing_method": "PyPDF"}, {"link": "https://www.sec.gov/files/form1-k.pdf", "Processing_method": "PyPDF"}, {"link": "https://www.sec.gov/files/form1-n.pdf", "Processing_method": "PyPDF"}, {"link": "https://www.sec.gov/files/form1-sa.pdf", "Processing_method": "PyPDF"}, {"link": "https://www.sec.gov/files/form1-z.pdf", "Processing_method": "PyPDF"}, {"link": "https://www.sec.gov/files/form10.pdf", "Processing_method": "PyPDF"}])
...
pinecone_params = {
        ...
        'pinecone_environment': Param('gcp-starter', type='string', description='Pinecone environment'),
        ...
        'metadata_fields': Param(metadata_fields_ls, type='string', description='JSON encoded list of metadata fields in the CSV'),
        }
...
def load_csv_into_pinecone(**kwargs):
    ...
    metadata_fields =[
         {"link": "https://www.sec.gov/files/form1.pdf", "Processing_method": "PyPDF"}, 
         {"link": "https://www.sec.gov/files/form1-a.pdf", "Processing_method": "PyPDF"}, 
         {"link": "https://www.sec.gov/files/form1-e.pdf", "Processing_method": "PyPDF"}, 
         {"link": "https://www.sec.gov/files/form1-k.pdf", "Processing_method": "PyPDF"}, 
         {"link": "https://www.sec.gov/files/form1-n.pdf", "Processing_method": "PyPDF"}, 
         {"link": "https://www.sec.gov/files/form1-sa.pdf", "Processing_method": "PyPDF"}, 
         {"link": "https://www.sec.gov/files/form1-z.pdf", "Processing_method": "PyPDF"},
         {"link": "https://www.sec.gov/files/form10.pdf", "Processing_method": "PyPDF"}
    ...
    index = pinecone.create_index(index_name,dimension=1536, metric="euclidean")

    # Read CSV
    df = pd.read_csv(source_path)

    index.upsert(vectors=zip(df.text, df.embedding, metadata_fields))
...
def manage_pinecone_index(**kwargs):
    ...
    environment = kwargs.get('pinecone_environment', 'gcp-startup')
...
def delete_pinecone_index(**kwargs):
    api_key = kwargs.get('pinecone_api_key')
    environment = kwargs.get('pinecone_environment', 'us-west1-gcp')
    index_name = kwargs.get('pinecone_index_name')
...
with dag:
    ...
    load_task >> create_update_task >> delete_task
